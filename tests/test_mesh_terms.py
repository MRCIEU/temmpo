...
class TestMeshTermsReleaseYearsTestCase(TestCase):
    ...
    def test_get_latest_mesh_term_release_year(self):
        ...
        self.assertEqual(self.latest_release, MeshTerm.get_latest_mesh_term_release_year())
        ...
        self.assertEqual(new_year, MeshTerm.get_latest_mesh_term_release_year())

    def test_get_top_level_mesh_terms(self):
        """Test class method on MeshTerm model."""
        expected_terms_2015 = ['A', 'B', 'C', ]
        expected_terms_2018 = ['A', 'B', 'C', 'D', ]
        found_terms_2015 = [x.term for x in MeshTerm.get_top_level_mesh_terms(2015)]
        found_terms_2018 = [x.term for x in MeshTerm.get_top_level_mesh_terms(2018)]
    ...
    def test_get_mesh_terms_by_year(self):
        ...
        found_terms_2015 = [x.term for x in MeshTerm.get_mesh_terms_by_year(2015)]
        found_terms_2018 = [x.term for x in MeshTerm.get_mesh_terms_by_year(2018)]
        found_terms_current_year = [x.term for x in MeshTerm.get_mesh_terms_by_year()]
    ...
    def test_convert_terms_to_current_year(self):
        ...
        converted_terms_names = [x.term for x in MeshTerm.convert_terms_to_current_year(terms_for_2015, 2015, 2018)]
